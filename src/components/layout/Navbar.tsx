      ...
      <div className="container mx-auto flex items-center justify-between gap-2 max-w-[1200px]">
        ...
        <div className="flex items-center gap-3">
          <div className="flex gap-2 text-[10px] font-bold">
            <div className="bg-white/10 rounded px-3 py-1 flex flex-col items-center min-w-[60px] border border-white/5">
              <span className="opacity-70 uppercase text-[8px]">BALANCE</span>
              <span className="text-sm font-black text-yellow-500">0.00</span>
            </div>
            <div className="bg-white/10 rounded px-3 py-1 flex flex-col items-center min-w-[60px] border border-white/5">
              <span className="opacity-70 uppercase text-[8px]">PROFIT</span>
              <span className="text-sm font-black text-green-400">0.00</span>
            </div>
            <div className="bg-white/10 rounded px-3 py-1 flex flex-col items-center min-w-[60px] border border-white/5">
              <span className="opacity-70 uppercase text-[8px]">EXPOSURE</span>
              <span className="text-sm font-black text-red-400">0</span>
            </div>
          </div>

          <button className="bg-yellow-500 hover:bg-yellow-400 text-black px-4 py-2 rounded font-black text-xs transition-all active:scale-95 flex items-center gap-2">
          ...
          >
            ...
            <div className="hidden md:flex items-center gap-1">
              <span className="text-[10px] font-black uppercase">C123051</span>
